...
<input type="radio" name="answer" value="compiling"  required>compiling
</div>
<div class="row" id="op2">
<input type="radio" name="answer" value="testing" required>testing
</div>
<div class="row"  id="op3"> 
<input type="radio" name="answer" value="running"  required>running
</div>
<div class="row"  id="op4">
<input type="radio" name="answer" value="debugging"  required>debugging
</div>
