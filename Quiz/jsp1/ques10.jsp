...
<input type="radio" name="answer" value="magnetic tape" required>mangnetic tape
</div>
<div class="row" id="op2">
<input type="radio" name="answer" value="printer" required>printer
</div>
<div class="row"  id="op3"> 
<input type="radio" name="answer" value="VDU terminal" required>VDU terminal
</div>
<div class="row"  id="op4">
<input type="radio" name="answer" value="assembler" required>assembler
</div>
