...
<input type="radio" name="answer" value="WWW"  required>WWW
</div>
<div class="row" id="op2">
<input type="radio" name="answer" value="browser" required>browser
</div>
<div class="row"  id="op3"> 
<input type="radio" name="answer" value="HTTP" required>HTTP
</div>
<div class="row"  id="op4">
<input type="radio" name="answer" value="B2B" required>B2B
</div>
