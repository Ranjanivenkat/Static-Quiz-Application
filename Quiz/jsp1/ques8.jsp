...
<input type="radio" name="answer" value="proxy server"  required>proxy server
</div>
<div class="row"  id="op3"> 
<input type="radio" name="answer" value="ip address" required>ip address
</div>
<div class="row"  id="op4">
<input type="radio" name="answer" value="domain name" required>domain name
</div>
